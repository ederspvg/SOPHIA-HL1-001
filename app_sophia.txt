...
if not st.session_state['autenticado']:
    ...
    with aba3:
        ...
        # Pode recarregar o modelo a cada interação, dependendo do cache do Streamlit.
        # Para aplicações de produção, pode-se otimizar com st.cache_resource se a inicialização for pesada.
        try:
        ...
        st.subheader("2. Consultar Base de Conhecimento")
